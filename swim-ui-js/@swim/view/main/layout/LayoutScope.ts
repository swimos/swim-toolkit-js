...
export const LayoutScope = {
  ...
  is(object: unknown): object is LayoutScope {
    if (typeof object === "object" && object !== null) {
      const scope = object as LayoutScope;
      return scope.hasLayoutAnchor !== void 0
          && scope.getLayoutAnchor !== void 0
          && scope.setLayoutAnchor !== void 0;
    }
    return false;
  },

  /** @hidden */
  decorateLayoutAnchor<L extends LayoutScope>(LayoutAnchor: LayoutAnchorConstructor,
