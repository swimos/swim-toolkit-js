...
export class NewAgentPrimaryAction extends PrimaryAction {
  /** @hidden */
  readonly _metaNodeRef: NodeRef;

  constructor(metaNodeRef: NodeRef) {
    super();
  ...
  createIcon(): SvgView {
    ...
    icon.append("path").fill("#9a9a9a").d("M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z");
    return icon;
  }
}
