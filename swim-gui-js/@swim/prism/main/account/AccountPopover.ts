...
export class AccountPopover extends PopoverView {
  /** @hidden */
  _viewController: PopoverViewController<AccountPopover> | null;
  ...
  get viewController(): PopoverViewController<AccountPopover> | null {
