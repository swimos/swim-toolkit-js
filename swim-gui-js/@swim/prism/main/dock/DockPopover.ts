...
export class DockPopover extends PopoverView {
  /** @hidden */
  _viewController: PopoverViewController<DockPopover> | null;
  ...
  get viewController(): PopoverViewController<DockPopover> | null {
